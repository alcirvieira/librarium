...
# Cria um sessão do back-end com o banco de dados.
...
def list_books():
    ...
    if 'user_id' not in session:
        ...
        flash('Para acessar o sofware, faça login...', 'warning')
        ...
        # Buca todos os livros cadastrado.
...
def edit_book(isbn):
    ...
    # Verifica se existe uma requisição de processamento de dados.
        if request.method == 'POST':
            ...
            # Busca o objeto que será atualizado (logicamente).
            ...
            livro.ano_publicacao = request.form['publicacao']
            livro.exemplares = int(request.form['exemplares'])

            # Confirma a transação.
            connection.commit()

            # Fechar a conexção com o banco de dados.
            connection.close()
